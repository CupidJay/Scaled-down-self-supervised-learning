...
parser.add_argument('--byol-dim', default=128, type=int,
                    help='feature dimension (default: 128)')
parser.add_argument('--byol-hidden-dim', default=512, type=int,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = byol.builder.BYOL(models.__dict__[args.arch](pretrained=False), image_size=args.input_size)
    print(model)
